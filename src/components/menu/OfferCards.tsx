...
export function BreakfastOfferCard({ breakfast }: { breakfast: Dictionary["menu"]["breakfastOffer"] }) {
  return (
    <Reveal className="card-hover mx-auto max-w-[560px] border border-gold/40 bg-gold/5 p-6">
...
export function MenuDelDiaCard({ menuDelDia }: { menuDelDia: Dictionary["menu"]["menuDelDia"] }) {
  return (
    <Reveal className="card-hover mx-auto max-w-[720px] border border-gold/40 bg-gold/5 p-6">
      <div className="flex items-baseline justify-between gap-4">
